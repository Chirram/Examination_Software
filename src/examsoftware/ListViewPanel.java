...
public class ListViewPanel extends javax.swing.JPanel {
    ...
    int randomSequence[],revRanSeq[];
    public ListViewPanel(int[] quetype,String[] answers,String[] filenames,String ID,String Subject,String Test,JToggleButton button1,JToggleButton button2,JToggleButton button3,JToggleButton button4,int[] randomSequence) {
    ...
    private void initComponents() {
        ...
        for(int m=0;m<nofque;m++){
            ...
            jlistPanel[m].add("Center",questionpanels[m]=new Images((m+1)+".rb",revRanSeq[m]+1));
            if(quetype[m]==0){
        ...
        for(int i=0;i<nofque;i++)
        {
            jPanel9.add(jlistPanel[randomSequence[i]]);
        }
