...
public class XamPanel extends javax.swing.JPanel {
  ...
  //      readFileNames(filenames);
    ...
    //   sortFileNames(filenames);
        ...
        initComponents();
        int randomSequence[]=genSequence(noofque);
        cardView=new CardViewPanel(quetype,answers,filenames,ID,Subject,Test,jToggleButton1,jToggleButton2,jToggleButton3,jToggleButton4,randomSequence);
        listView=new ListViewPanel(quetype,answers,filenames,ID,Subject,Test,jToggleButton1,jToggleButton2,jToggleButton3,jToggleButton4,randomSequence);
    ...
    int[] genSequence(int max)
    {   
        int d;
        for(d=max-1;d>=0;d--)
        {
            if(quetype[d]==3)continue;
            else break;
        }
        int seq[]=new int[max];
        ...
        for(int i=1;i<max;i++)
        {
           if(i<=d) seq[i]=arlst.remove((int)(Math.random()*arlst.size()));
           else seq[i]=i;
        }
        return seq;
    }
